...
-Up Arrow key:
Add an octave to the max octave range

-Down Arrow key:
Add an octave to the min octave range

-R:
Resets the octave range to remove excess octaves

-A:
Adds a measure to the end of the song

-S:
Removes unnecessary measures at the end of the song.
